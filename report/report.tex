...
%
% Template option:
%   [preprint]      -> clean preprint style, "Preprint." in footer
%   [final, main]   -> camera-ready style with NeurIPS conference notice
%   (no option)     -> anonymous submission style with line numbers
% Class projects usually want [preprint]; switch the line below.

\documentclass{article}

\usepackage[preprint]{neurips_2026}

% Packages the NeurIPS template does NOT load itself
...
% NeurIPS author block: name / affiliation / address / email per author,
% joined with \And (or \AND for a hard line-break between groups).
\author{%
  Ting-Yu Yu\\
  ECE 228, Team 17\\
  UC San Diego\\
  \texttt{tiy035@ucsd.edu}\\
  \And
  Yun-Chen Tsai\\
  ECE 228, Team 17\\
  UC San Diego\\
  \texttt{yut037@ucsd.edu}\\
}
...
\input{tables/multi_vs_global.tex}
